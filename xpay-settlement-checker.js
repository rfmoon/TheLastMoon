(() => {
  ...
  function calculate(rows, cairDate){
    ...
    // BATAS TEGAS:
    // 00:00:00 - 23:29:59 = SETTLEMENT
    // 23:30:00 - 23:59:59 = CUTOFF
    // Jadi 23:30:00 tepat SUDAH CUTOFF.
    const cutoffStart=23*3600+30*60;
    ...
    for(const r of rows){
      ...
      if(p.date===settlementDate && p.sec<cutoffStart){
        settlement.push({...r,type:'SETTLEMENT'});
      }

      if(p.date===cutoffDate && p.sec>=cutoffStart && p.sec<=dayEnd){
    ...
    statusEl.textContent=
      `${mode==='db' ? 'Cloudflare D1' : 'CSV'} • Settlement ${displayDate(settlementDate)} + `+
  ...
  function setMode(nextMode){
    ...
    if(mode==='csv'){
      hintText.innerHTML=
        ...
        'Settlement mengambil PAYMENT <b>sebelum 23:30:00</b>; Cutoff mengambil PAYMENT '+
        '<b>mulai 23:30:00 s/d 23:59:59</b>. Jadi transaksi tepat <b>23:30:00</b> dan setelahnya masuk '+
        '<b>CUTOFF</b>. Hanya STATUS <b>SUCCESS</b>.';
      ...
      hintText.innerHTML=
        ...
        'Logika: Settlement H-1 <b>00:00:00–23:29:59</b>; Cutoff H-2 <b>23:30:00–23:59:59</b>. '+
        'Transaksi tepat <b>23:30:00</b> sudah masuk <b>CUTOFF</b>.';
