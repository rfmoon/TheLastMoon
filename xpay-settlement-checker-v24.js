(() => {
  ...
  function calculate(rows, cairDate){
    ...
    // - SETTLEMENT date == Tanggal Cair => SETTLEMENT
    ...
    for(const r of rows){
      ...
      if(p.sec===exact233000){
        ...
        if(settlementDateInRow===cairDate){
          settlement.push({...r,type:'SETTLEMENT'});
          continue;
        }
    ...
    statusEl.textContent=
      `${mode==='db' ? 'Cloudflare D1' : 'CSV'} • V24 • Settlement ${displayDate(settlementDate)} + `+
  ...
  function setMode(nextMode){
    ...
    if(mode==='csv'){
      hintText.innerHTML=
        ...
        'Khusus <b>23:30:00</b>, sistem membaca kolom <b>SETTLEMENT</b>: tanggal sama dengan Tanggal Cair = '+
      ...
      hintText.innerHTML=
        ...
        'V24: Settlement normal H-1 <b>00:00:00–23:29:59</b>; Cutoff normal H-2 <b>23:30:01–23:59:59</b>. '+
